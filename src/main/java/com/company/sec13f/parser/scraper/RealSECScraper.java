    ...
    public Filing get13FDetails(String accessionNumber, String cik) throws IOException, InterruptedException {
        ...
        try {
            ...
            if (directoryContent != null) {
                ...
                while (xmlMatcher.find()) {
                    ...
                    if (!xmlFile.equals("primary_doc.xml")) {
        ...
        for (String fileName : possibleFiles) {
            try {
                ...
                if (content != null && (content.contains("informationTable") || content.contains("13F"))) {
                    return parse13FContent(content, accessionNumber, cik);
                }
            } catch (Exception e) {
